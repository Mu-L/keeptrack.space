...
export const pluginManifest: PluginDescriptor[] = [
  ...
  },
  {
    ...
    proImport: () => import('../plugins-pro/watchlist/watchlist'),
  ...
  },
  {
    ...
    ossImport: () => import('./seismic-activity/seismic-activity'),
    ossClassName: 'SeismicActivityPlugin',
    proImport: () => import('../plugins-pro/seismic-activity/seismic-activity'),
    proClassName: 'SeismicActivityPlugin',
    defaultConfig: { enabled: true, order: 355 },
  },
  {
    configKey: 'AuroraPlugin',
    ossImport: () => import('./aurora/aurora'),
    ossClassName: 'AuroraPlugin',
    proImport: () => import('../plugins-pro/aurora/aurora'),
    proClassName: 'AuroraPlugin',
    defaultConfig: { enabled: true, order: 356 },
  },
  {
    configKey: 'NaturalEventsPlugin',
    ossImport: () => import('./natural-events/natural-events'),
    ossClassName: 'NaturalEventsPlugin',
    proImport: () => import('../plugins-pro/natural-events/natural-events'),
